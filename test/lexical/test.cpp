...
int main() {
    ...
    std::vector<int> exp1 = {
        Token::Type::SERVER, Token::Type::OPEN_BRACE,
        Token::Type::LISTEN, Token::Type::VALUE, Token::Type::SEMICOLON,
        Token::Type::SERVER_NAME, Token::Type::VALUE, Token::Type::SEMICOLON,
        Token::Type::ROOT, Token::Type::VALUE, Token::Type::SEMICOLON,
        Token::Type::CLIENT_MAX_BODY_SIZE, Token::Type::VALUE, Token::Type::SEMICOLON,
        Token::Type::ERROR_PAGE, Token::Type::VALUE, Token::Type::VALUE, Token::Type::SEMICOLON,
        Token::Type::AUTOINDEX, Token::Type::VALUE, Token::Type::SEMICOLON,
        Token::Type::ALLOWED_METHODS, Token::Type::VALUE, Token::Type::VALUE, Token::Type::SEMICOLON,
    ...
    std::vector<int> exp2 = {
        Token::Type::LOCATION, Token::Type::LOCATION_MODIFIER, Token::Type::LOCATION_PATH, Token::Type::OPEN_BRACE,
        Token::Type::CGI_EXTENSION, Token::Type::VALUE, Token::Type::SEMICOLON,
        Token::Type::ROOT, Token::Type::VALUE, Token::Type::SEMICOLON,
        Token::Type::ALLOWED_METHODS, Token::Type::VALUE, Token::Type::VALUE, Token::Type::SEMICOLON,
        Token::Type::CLOSE_BRACE,
        Token::Type::LOCATION, Token::Type::LOCATION_PATH, Token::Type::OPEN_BRACE,
        Token::Type::ROOT, Token::Type::VALUE, Token::Type::SEMICOLON,
        Token::Type::ALLOWED_METHODS, Token::Type::VALUE, Token::Type::VALUE, Token::Type::VALUE, Token::Type::SEMICOLON,
        Token::Type::AUTOINDEX, Token::Type::VALUE, Token::Type::SEMICOLON,
        Token::Type::CLOSE_BRACE
    };
    ...
    testTokens("default.config", file, exp3);
    return 0;
}